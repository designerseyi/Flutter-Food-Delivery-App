...
import 'package:foodie/revamp/api/messaging.dart';
...
import 'package:foodie/revamp/pages/dashboard.dart';
...
class _RestaurantPageState extends State<RestaurantPage> {
  ...
  String fcmtoken ='ex33oFQePY4:APA91bFdQu1GXYNhtuM5pe12z8Djs7JeBFuKGb8fCLgr5je4PhkoEHfOtyR7w7c2SR9EklpGwvhHh_D5j6KcUHdV6AM1qvQDs-wx5qHekJ-bTS5XhyqBS6DN82VTYvawPlw-Dk_pZVZ4';
  @override
  Widget build(BuildContext context) {
    ...
    print('restuarant :  ${widget.restaurant.products}');
      ...
      return Scaffold(
              body: Stack(
               ...
               SliverFillRemaining(
                 ...
                 stream: Firestore.instance.collection('MenuItems').where('res',isEqualTo: widget.restaurant.details.res)
            .snapshots(),
                 ...
                 // print(' menuItem:${data.documents}');
                   ...
                   widget.restaurant.products.forEach((newMap){
                       ...
                       productList.add(p);
                      //  print('product list :${p.runtimeType}');
                   });  
  ...
  double swidth;
   ...
   return  Padding(
     ...
     child: Column(
         ...
         print('my products : ${Products[int.parse(productid)].product_variation}');
    ...
    return SingleChildScrollView(
          child: Padding(
            ...
            child: Column(
              ...
              child: StreamBuilder(
                 ...
                 builder: (context, snapshot){
                   ...
                   print('getCartList : ${snapshot.data}');
            ...
            child: FlatButton(
              ...
              }, child: Text("PROCEED TO CHECKOUT",style:TextStyle(color: Colors.white, fontSize: 20,fontWeight: FontWeight.w600),),color: greenColor,),
                      )
                    ],
                  ),
...
Widget _cartItem(List<CartItemWrapper> listCartItems){
  ...
  Future sendTokenToServer(String fcmToken) async {
    print('Token: $fcmToken');

    List<CartItemWrapper> mCart = List<CartItemWrapper>();
    //   cartBloc.getCartList.listen((data){
    //       mCart = data;
    //   });

      //mCart = await generateCartList(cartBloc.getCartList);
    ...
    if (response.statusCode != 200) {
      Scaffold.of(context).showSnackBar(SnackBar(
        ...
        content:
            ...
            print('[${response.statusCode}] Success message: ${response.body}');
    ...
    //token
    //cCF0JoQv5Po:APA91bEVmN_LmfrOmmot2e-_h-38nuJcTE8ZDtsT9HYWmyygGppGbXW66ic_VP80vUEFXkQgQaEfnzGsvTrbytii15mT1kgPIkeemOa8CrcxGq4yC1FRJSYSXcNMrc_8po-iOl80Pu5I
  }

Future<List<CartItemWrapper>> generateCartList(Stream<List<CartItemWrapper>> stream) async {
       List<CartItemWrapper> mCart = List<CartItemWrapper>();
